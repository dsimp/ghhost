...
export async function GET(request) {
  ...
  try {
    ...
    const [profileRes, regLogRes, playoffLogRes] = await Promise.allSettled([
      fetchNBA('playerprofilev2', { PlayerID: playerId, PerMode: 'PerGame', LeagueID: '10' }),
      fetchNBA('playergamelog', { PlayerID: playerId, Season: season, SeasonType: 'Regular Season', LeagueID: '10' }),
      fetchNBA('playergamelog', { PlayerID: playerId, Season: season, SeasonType: 'Playoffs', LeagueID: '10' })
    ]);
